...
class GitHubCollector:
    ...
    def get_branch_protection(self, repo_name: str, branch: str) -> Api
...
def make_report(
    ...
    lines.append(
        ...
        "This evidence package captures the organization, repository, access, and mon    for team in teams:
        slug = team.get("slug")
